...
SECRET_KEY = '-9_e#z#heqjpp4x#0#%nrd8874l#l7+y55ryaj()ah1s+_@k-^'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://192.168.28.139:6379/0",
        "OPTIONS": {
    ...
    "session": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.28.139:6379/1",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    ...
    "verify_code": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.28.139:6379/2",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'liqijerryliqi@163.com'
# 在邮箱中设置的客户端授权密码
